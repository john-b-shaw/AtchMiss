...
load('netstruct16MA_v4.mat');
load('netstruct16MM_v5.mat');
%load('netstruct50GL_v2.mat');
load('netstruct16GL_v1.mat');
...
[poptim50M,fval50M,exitflag] = fminunc(@(p)arbbwnpo_v8_5_Thalweg(netstruct50M,AtchMiss,Q,p,delzmatrix50M,1),[0.3 0.6 0.24 0.1 0.5 0.6],options);
[delz2, printout50M]=arbbwnpo_v8_5_Thalweg(netstruct50M,AtchMiss,Q,poptim50M,delzmatrix50M,2)
...
[poptim16MD,fval16MD,exitflag] = fminunc(@(p)arbbwnpo_v8_5_Thalweg(netstruct16MD,AtchMiss,Q,p,delzmatrix16MD,1),[0.35 0.48 0.29 0.4 0.5 0.5],options);
[delz2, printout16MD]=arbbwnpo_v8_5_Thalweg(netstruct16MD,AtchMiss,Q,poptim16MD,delzmatrix16MD,2)
...
[poptim16MA,fval16MA,exitflag] = fminunc(@(p)arbbwnpo_v8_5_Thalweg(netstruct16MA,AtchMiss,Q,p,delzmatrix16MA,1),[0.3 0.5],options);
[delz2, printout16MA]=arbbwnpo_v8_5_Thalweg(netstruct16MA,AtchMiss,Q,poptim16MA,delzmatrix16MA,2)
Atchplot16MA=[printout16MA(3).simout(1:end,:);printout16MA(2).simout(2:end,:);printout16MA(1).simout(2:end,:)];

[poptim16MM,fval16MM,exitflag] = fminunc(@(p)arbbwnpo_v8_5_Thalweg(netstruct16MM,AtchMiss,Q,p,delzmatrix16MM,1),[0.3 0.5],options);
[delz2, printout16MM]=arbbwnpo_v8_5_Thalweg(netstruct16MM,AtchMiss,Q,poptim16MM,delzmatrix16MM,2)
Atchplot16MM=[printout16MM(3).simout(1:end,:);printout16MM(2).simout(2:end,:);printout16MM(1).simout(2:end,:)];

[poptim16GL,fval16GL,exitflag] = fminunc(@(p)arbbwnpo_v8_5_Thalweg(netstruct16GL,AtchMiss,Q,p,delzmatrix16GL,1),[0.3 0.5],options);
[delz2, printout16GL]=arbbwnpo_v8_5_Thalweg(netstruct16GL,AtchMiss,Q,poptim16GL,delzmatrix16GL,2)
...
for i=1:length(bins)-1;
    ...
    x=(bins(i)+bins(i+1))/2;
    mrouts(i,:)=[x eta16 eta50 eta50/eta16 w16 w50 w50/w16 csa16 csa50];
end
...
legend([pR16 pR50 pR16D pR16A pR16M pR16GL],{'R16','R50','R16D','R16A','R16M','R16GL'},'Location','east')
