...
Qset=[10000:5000:25000]';
Cf=0.01;%This is just to fill the voice in v6Cf, it is a dummy variable.

AtchCfset=linspace(0.001,0.004,5)';
MRCfset=linspace(0.001,0.004,5)';
tic;
for h=1:size(Qset,1);
...
save('Cf_Analyzer_v8varyQ.mat') 

figure
subplot(1,3,1)
set(gca,'Units','inches','Position',[0.5 0.5 2.25 2],'FontSize',12)
image(MRCfset,AtchCfset,abs(AtchMisspartition50(:,:,3)),'CDataMapping','scaled')
hold on
...
image(MRCfset,AtchCfset,sqrt(mean(dz(:,:,:,3).^2,3)),'CDataMapping','scaled')
hold on
plot(0.0025,0.00325,'ko')
daspect([1 1 1])
colorbar
