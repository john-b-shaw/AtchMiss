...
load('netstruct16M_v12.mat'); %This is the network structure file for R_pre
load('netstruct50M_v13.mat'); %For R_post
load('netstruct16MD_v8.mat'); %For R_pre_D
load('netstruct16MA_v5.mat'); %For R_pre_A
load('netstruct16MM_v5.mat'); %For R_pre_M
load('netstruct16GL_v2.mat'); %For R_pre_GL
load('ValidatorData_v1.mat'); %This contains all of the hydrograph data.

Q=18300;%Here is the upstream discharge in m^3/s.
